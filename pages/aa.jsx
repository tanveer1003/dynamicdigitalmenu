            ...
            <div className="container pt-1">
                <div className="section-header d-flex justify-content-between align-items-center">
                    ...
                    <div className="header-right">
                        <FaList className="view-icon text-primary" />
                        <FaTh className="view-icon text-primary" />
                    </div>
                </div>
    ...
    const productData = [
        {
            ...
            tags: [
                ...
                { label: "Gluten Free", icon: wheatIcon },
                { label: "Spicy", icon: chilleIcon }
            ]
        },
        {
            id: 2,
        ...
        },
        {
            ...
            title: "Red Wines",
            price: "$8.00",
            description: "Rich and full-bodied, with hints of dark berries and oak.",
        ...
        },
        {
            ...
            title: "White Wines",
            price: "$10.00",
            description: "Light and crisp, with flavors of citrus and honeydew melon.",
            image: "https://s3-alpha-sig.figma.com/img/4b7f/7a6a/d65cb7a5fce2f7a0e5b2c9faad6d8fc3?Expires=1743379200&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=PjVfsYXXHc0UmpkZBPX7rueMQF1TfH8z9LCxVO8tU7vgcYV5ZoMRp6E7ow8fuPiRsjib4HymleFk8aKCDHqHts5hOOkOwKa3F-tEV9Q6O-DnTwgUbiS0Uzm3JvFY9UOSjSBxT-H8TWdx6mgJfBHTZFYxpdB37GZG~kgHClYHVc5BkfvdW~wB9GQpzpXkrR7He-ZOeLuvb~tkc7JKVoeuTuUEBb1fHzDuhWw8X4y1u-Jgliv9KHg~YvxaCbmc5YxZVoJ1g5nPy6QbHgFxEr9s4DrYoXf6exmvWZWcEj1H-Hzmr0CRHFtcgbiUNvVDl9PDSzGUBI5sFAV2PfMXczskA__",
            tags: [
                { label: "Vegan", icon: leafIcon },
                { label: "Organic", icon: chilleIcon }
            ]
        },
        {
            id: 5,
                            ...
                            <div className="product-details">
                                ...
                                <div className="product-row">
                                    ...
                                    {product.tags.map((tag, index) => (
                                        <div key={index} className={`tag ${formatTag(tag.label)}`}>
                                            {tag.label}
                                        </div>
                                    ))}
                        ...
                        <div className="modal-body">
                            {selectedProduct && (
                                <>
                                    ...
                                    <p>
                                        <strong>Tags:</strong>{" "}
                                        {selectedProduct.tags.map(tag => tag.label).join(", ")}
                                    </p>
                                </>
                            )}
                        </div>
    ...
    const drinksData = [
        {
            ...
            tags: [["Vegan",leafIcon], "Gluten Free", "Spicy"],
        },
        {
            id: 2,
            subcategory: "Beer",
    ...
    return (
        ...
        <div >
            ...
            <div className='pt-2' style={{ background: "rgb(243 246 250)" }} >
                ...
                <div className="container mt-3 py-2 mb-4 bg-white">
