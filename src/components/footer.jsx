            ...
            <div className="container mb-4">
                <div className="row">
                    ...
                    <div className="col-md-6">
                        ...
                        }}><FaClock className="me-2" /> {translations[language].FooterTitle1}</h5>
                        <ul className="list-unstyled d-flex  flex-column gap-2 pt-3" style={{ 
                    ...
                    <div className="col-md-4">
                        <h5 style={{
                            textAlign: language === "he" ? "right" : "left",
                            direction: language === "he" ? "rtl" : "ltr"
                        }}>{translations[language].FooterTitle2}</h5>
                        <ul className="list-unstyled d-flex flex-column gap-2 pt-3" style={{ 
                            color: "#6B7280",
                            fontSize: 12,
                            textAlign: language === "he" ? "right" : "left",
                    ...
                    */}
                    ...
                    <div className="col-md-6">
                        <h5 style={{
                            textAlign: language === "he" ? "right" : "left",
                            direction: language === "he" ? "rtl" : "ltr"
                        }}>{translations[language].FooterTitle3}</h5>
                        <div className="mb-3 pt-3" style={{
                            textAlign: language === "he" ? "right" : "left",
                            direction: language === "he" ? "rtl" : "ltr"
                        }} >
                        ...
                        <p style={{ color: "#6B7280", fontSize: 12,textAlign: language === "he" ? "right" : "left",
                            direction: language === "he" ? "rtl" : "ltr" }}>{translations[language].ConnectUsMessage}</p>
